...
- (void)setupUI{
    ...
    self.title = @"openVC之图像内容矩形检测和透视矫正1";
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithTitle:@"裁剪" style:UIBarButtonItemStylePlain target:self action:@selector(cropAction)];
    [self selectPhoto];
